...
goog.exportSymbol('proto.Catalyst.Protocol.Transaction.BaseEntry', null, global);
...
proto.Catalyst.Protocol.Transaction.ConfidentialEntry.prototype.getRangeProof = function() {
  return /** @type{?proto.Catalyst.Protocol.Transaction.RangeProof} */ (
    jspb.Message.getWrapperField(this, proto.Catalyst.Protocol.Transaction.RangeProof, 3));
};
...
/**
 * @param {number} value
 * @return {!proto.Catalyst.Protocol.Transaction.BaseEntry} returns this
 */

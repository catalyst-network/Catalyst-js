...
export class PublicEntry extends jspb.Message {
  hasBase(): boolean;
  clearBase(): void;
  getBase(): BaseEntry | undefined;
  setBase(value?: BaseEntry): void;
...
export class BaseEntry extends jspb.Message {
  getNonce(): number;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): BaseEntry.AsObject;
  static toObject(includeInstance: boolean, msg: BaseEntry): BaseEntry.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: BaseEntry, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): BaseEntry;
  static deserializeBinaryFromReader(message: BaseEntry, reader: jspb.BinaryReader): BaseEntry;
}

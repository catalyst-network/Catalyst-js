...
goog.require('proto.Catalyst.Protocol.DfsMarketplace.BlockChallengeRequest');
...
proto.Catalyst.Protocol.DfsMarketplace.BlockChallengeBroadcast.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    challengedpeer: (f = msg.getChallengedpeer()) && proto.Catalyst.Protocol.Common.PeerId.toObject(includeInstance, f),
    challengedby: (f = msg.getChallengedby()) && proto.Catalyst.Protocol.Common.PeerId.toObject(includeInstance, f)
  };
...
/**
 * optional BlockChallengeRequest originalChallenge = 1;
...
proto.Catalyst.Protocol.DfsMarketplace.BlockChallengeBroadcast.prototype.clearOriginalchallenge = function() {
  this.setOriginalchallenge(undefined);
};
...
/**
 * optional Catalyst.Protocol.Common.PeerId challengedPeer = 3;
...
proto.Catalyst.Protocol.DfsMarketplace.BlockChallengeBroadcast.prototype.getChallengedpeer = function() {
  return /** @type{?proto.Catalyst.Protocol.Common.PeerId} */ (
    jspb.Message.getWrapperField(this, proto.Catalyst.Protocol.Common.PeerId, 3));
};
...
proto.Catalyst.Protocol.DfsMarketplace.BlockChallengeBroadcast.prototype.clearChallengedpeer = function() {
  this.setChallengedpeer(undefined);
};
...
/**
 * optional Catalyst.Protocol.Common.PeerId challengedBy = 4;
 * @return {?proto.Catalyst.Protocol.Common.PeerId}
 */
proto.Catalyst.Protocol.DfsMarketplace.BlockChallengeBroadcast.prototype.getChallengedby = function() {
  return /** @type{?proto.Catalyst.Protocol.Common.PeerId} */ (
    jspb.Message.getWrapperField(this, proto.Catalyst.Protocol.Common.PeerId, 4));
};
...
proto.Catalyst.Protocol.DfsMarketplace.BlockChallengeBroadcast.prototype.clearChallengedby = function() {
  this.setChallengedby(undefined);
};

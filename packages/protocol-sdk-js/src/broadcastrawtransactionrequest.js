...
proto.Catalyst.Protocol.Rpc.Node.BroadcastRawTransactionRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    transaction: (f = msg.getTransaction()) && proto.Catalyst.Protocol.Transaction.TransactionBroadcast.toObject(includeInstance, f)
  };
...
/**
 * optional Catalyst.Protocol.Transaction.TransactionBroadcast transaction = 1;
...
proto.Catalyst.Protocol.Rpc.Node.BroadcastRawTransactionRequest.prototype.getTransaction = function() {
  return /** @type{?proto.Catalyst.Protocol.Transaction.TransactionBroadcast} */ (
    jspb.Message.getWrapperField(this, proto.Catalyst.Protocol.Transaction.TransactionBroadcast, 1));
};


/** @param {?proto.Catalyst.Protocol.Transaction.TransactionBroadcast|undefined} value */

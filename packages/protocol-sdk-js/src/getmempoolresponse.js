...
goog.require('proto.Catalyst.Protocol.Transaction.TransactionBroadcast');
...
proto.Catalyst.Protocol.Rpc.Node.GetMempoolResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.Catalyst.Protocol.Transaction.TransactionBroadcast.toObject, includeInstance)
  };
...
proto.Catalyst.Protocol.Rpc.Node.GetMempoolResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.Catalyst.Protocol.Transaction.TransactionBroadcast;
      reader.readMessage(value,proto.Catalyst.Protocol.Transaction.TransactionBroadcast.deserializeBinaryFromReader);
...
proto.Catalyst.Protocol.Rpc.Node.GetMempoolResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.Catalyst.Protocol.Transaction.TransactionBroadcast.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Array<!proto.Catalyst.Protocol.Transaction.TransactionBroadcast>}
 */
proto.Catalyst.Protocol.Rpc.Node.GetMempoolResponse.prototype.getTransactionsList = function() {
  return /** @type{!Array<!proto.Catalyst.Protocol.Transaction.TransactionBroadcast>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.Catalyst.Protocol.Transaction.TransactionBroadcast, 1));
};


/** @param {!Array<!proto.Catalyst.Protocol.Transaction.TransactionBroadcast>} value */
...
/**
 * @param {!proto.Catalyst.Protocol.Transaction.TransactionBroadcast=} opt_value
...
proto.Catalyst.Protocol.Rpc.Node.GetMempoolResponse.prototype.addTransactions = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.Catalyst.Protocol.Transaction.TransactionBroadcast, opt_index);
};
